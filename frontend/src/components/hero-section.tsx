                ...
                {isVideoOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                onClick={handleCloseDemo}
                                className="absolute top-4 right-4 z-10 w-10 h-10 flex items-center justify-center rounded-full bg-black/50 border border-white/20 text-white hover:bg-white/10 transition-colors"
                            >
                                <X className="w-5 h-5" />
                            </button>
                            ...
                            <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-zinc-900 to-black pointer-events-none">
                                <div className="text-center">
                                    ...
                                    <p className="text-white/60 text-sm">Upload your demo video to /public/assets/demo-video.mp4</p>
                                </div>
                            </div>
                        </motion.div>
                    </motion.div>
